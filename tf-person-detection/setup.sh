...
#curl -O  http://download.tensorflow.org/models/object_detection/ssd_inception_v2_coco_11_06_2017.tar.gz
#curl -O  http://download.tensorflow.org/models/object_detection/rfcn_resnet101_coco_11_06_2017.tar.gz
#curl -O  http://download.tensorflow.org/models/object_detection/faster_rcnn_resnet101_coco_11_06_2017.tar.gz
...
#curl -O  ftp://mi.eng.cam.ac.uk/pub/mttt2/models/vgg16.npy
